...
const allHistoryRecords = [
  ...
  },
  {
    ...
    time: '12:00',
    location: '국민대',
    lat: 37.6113, lng: 126.9982,
    thumbnail: '/photos/0406.jpg',
    gradient: null,
    weather: { emoji: '☀️', label: '맑음' },
    aiRecord: '국민대에서의 봄날. 따사로운 햇살 아래 캠퍼스를 거닐며 담아낸 한 컷.',
    emotionTags: [{ icon: '☀️', label: '맑음' }, { icon: '🏫', label: '캠퍼스' }],
    categoryTags: ['국민대', '봄', '캠퍼스'],
    userNote: '',
  },
  {
    id: 'hist_0407',
    ...
    location: '국민대',
    lat: 37.6113, lng: 126.9982,
    thumbnail: '/photos/0407.jpg',
    gradient: null,
    weather: { emoji: '☀️', label: '맑음' },
    aiRecord: '국민대 캠퍼스, 봄이 절정인 날. 파란 하늘과 초록이 어우러진 풍경 속에서 계절의 한가운데를 걷고 있었다.',
    emotionTags: [{ icon: '🌿', label: '자연' }, { icon: '😊', label: '행복' }],
    categoryTags: ['국민대', '봄', '캠퍼스'],
    userNote: '',
  },
]
